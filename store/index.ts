  ...
  categories: [
    {
      ...
      categoryIndex: 0,
      questions: [
        { questionIndex: 0, text: 'お相手の髪型や髭は整っていましたか？', rating: 0 },
        { questionIndex: 1, text: 'お相手の体臭や口臭は気になりませんでしたか？', rating: 0 },
        { questionIndex: 2, text: 'お相手の服装はデートに適したものでしたか？', rating: 0 },
        { questionIndex: 3, text: 'お相手のアクセサリーや持ち物は好印象でしたか？', rating: 0 },
        { questionIndex: 4, text: 'お相手の話し方や声のトーンは好感が持てましたか？', rating: 0 },
